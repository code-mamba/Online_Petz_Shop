...
<link rel="stylesheet" href = "DeletePets.css">
  ...
  <div class="container py-5 h-100">
    <div class="row d-flex align-items-center justify-content-center h-100">
      ...
      <div class="col-md-7 col-lg-5 col-xl-5 offset-xl-1">
        <form class = "form" action="AdminDeletePet" method = "post">
          <!-- Email input -->
          <div class="form-outline mb-4">
          	<label class="form-label" for="form1Example13" style="color:black;font-size: 25px">Enter Pet id</label>
            <input type="text" id="form1Example13" name="PetId" class="form-control form-control-lg" placeholder="Enter Pet Id to Delete" />
            <br>
          </div>
