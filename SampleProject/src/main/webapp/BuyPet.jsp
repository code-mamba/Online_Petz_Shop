...
<div class="navbar">
        ...
        <form class = "form" action="CustomerBuyPet" method="get">
          <!-- username -->
          <div class="form-outline mb-4">
          	<label class="form-label" for="form1Example13" style="color:white;font-size: 25px">Enter Pet Id To Buy</label>
            <input type="text" id="form1Example13" name="PetId" class="form-control form-control-lg" placeholder="Enter Pet Id " />
            <br>
          </div>
                  <div class="form-outline mb-4">
          	<label class="form-label" for="form1Example13" style="color:white;font-size: 25px">Enter Pet Quantity To Buy</label>
            <input type="text" id="form1Example13" name="PetQuantity" class="form-control form-control-lg" placeholder="Enter Quantity " />
            <br>
          </div>
                            <div class="form-outline mb-4">
